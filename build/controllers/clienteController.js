...
class ClienteController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const oficios = yield database_1.default.query('select * from usuario_cliente');
            res.json(oficios[0]);
        });
    }
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('select * from usuario_cliente where id_usuario = ?', [id]);
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield database_1.default.query('insert into usuario_cliente set ?', [req.body]);
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('update usuario_cliente set ? where id_usuario = ?', [req.body, id]);
